...
chcp 65001 > nul
:: 65001 - UTF-8
:: Стратегия для Telegram с использованием multisplit техники
...
--filter-tcp=80,443 --hostlist-domains=telegram.org --dpi-desync=multisplit --dpi-desync-split-seqovl=568 --dpi-desync-split-pos=1 --dpi-desync-split-seqovl-pattern="%BIN%tls_clienthello_4pda_to.bin" --new ^
